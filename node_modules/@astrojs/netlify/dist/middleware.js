 ...
 *
 */
export async function generateEdgeMiddleware(astroMiddlewareEntryPointPath, outPath, netlifyEdgeMiddlewareHandlerPath) {
    const entryPointPathURLAsString = JSON.stringify(fileURLToPath(astroMiddlewareEntryPointPath).replace(/\\/g, '/'));
